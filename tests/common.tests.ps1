...
Pester\Describe "Manifest" {
    ...
    Pester\It "has a valid guid" {
        $ManifestHash.Guid | Should Be "c4e893ac-fb28-4881-bb77-6df31b69c041"
    }
    ...
    Pester\It 'has a valid license Uri' {
        $ManifestHash.PrivateData.Values.LicenseUri | Should Be "https://github.com/cwchapma/Executable/blob/master/Executable/license"
    }
    
    Pester\It 'has a valid project Uri' {
        $ManifestHash.PrivateData.Values.ProjectUri | Should Be "https://github.com/cwchapma/Executable"
    }
